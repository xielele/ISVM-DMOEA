...
try
	...
	% Add -largeArrayDims on 64-bit machines of MATLAB
		...
		mex COMPFLAGS="\$COMPFLAGS -std=c99" -largeArrayDims svmtrain.c ../svm.cpp svm_model_matlab.c
		mex COMPFLAGS="\$COMPFLAGS -std=c99" -largeArrayDims svmpredict.c ../svm.cpp svm_model_matlab.c
	end
catch
